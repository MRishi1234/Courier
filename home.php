        ...
        <div class="row" >
          <div class="col-12 col-sm-6 col-md-4" >
            <div class="small-box bg-light shadow-sm border" >
              <div class="inner" style="background: linear-gradient(#33ccff, #afb7bc);">
                <h3><?php echo $conn->query("SELECT * FROM branches")->num_rows; ?></h3>

                <p >Total Branches</p>
              </div>
              <div class="icon" style="color:#000847">
           ...
           <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              ...
              <div class="icon" style="color:#aa6c39">
                <i class="fa fa-boxes" ></i>
              </div>
            </div>
          </div>
           <div class="col-12 col-sm-6 col-md-4" st>
            <div class="small-box bg-light shadow-sm border">
              <div class="inner" style="background: linear-gradient(#33ccff, #afb7bc);">
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner" style="background: linear-gradient(#bbbbbb, #dbd7d7 );">
